...
# Output directories
OUTPUT_DIRS = {
    'forward_snaps' : "/mnt/myshare/Андрей/!Аспирантура/synth_gal/forward_snaps",
    'adjoint_snaps' : "/mnt/myshare/Андрей/!Аспирантура/synth_gal/adjoint_snaps",
    'nogal': "/mnt/myshare/Андрей/!Аспирантура/synth_gal/nogal",
    'gal': "/mnt/myshare/Андрей/!Аспирантура/synth_gal/gal",
    'hods': "/mnt/myshare/Андрей/!Аспирантура/synth_gal/hods",
    'gradients': "/mnt/myshare/Андрей/!Аспирантура/synth_gal/gradients",
    'images': "/mnt/myshare/Андрей/!Аспирантура/synth_gal/images",
    'results': "/mnt/myshare/Андрей/!Аспирантура/synth_gal/logs"
}
...
def setup_truemodel_and_geometry(path_data):
    ...
    return model_nogal, model_gal, dataset, velmodel