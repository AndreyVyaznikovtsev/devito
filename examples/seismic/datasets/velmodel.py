...
class VelocityModel:
    ...
    def pad_left(self, n_cells):
        ...
        self._current_model["vel"] = np.pad(self._current_model["vel"], ((0, 0), (n_cells, 0)), mode="edge")
        self._current_model["vxvz"] = np.pad(self._current_model["vxvz"], ((0, 0), (n_cells, 0)), mode="edge")
    ...
    def pad_right(self, n_cells):
        ...
        # Update velocity arrays with edge padding
        self._current_model["vel"] = np.pad(self._current_model["vel"], ((0, 0), (0, n_cells)), mode="edge")
        self._current_model["vxvz"] = np.pad(self._current_model["vxvz"], ((0, 0), (0, n_cells)), mode="edge")
    ...
    def pad_top(self, n_cells):
        ...
        # Update velocity arrays with edge padding
        self._current_model["vel"] = np.pad(self._current_model["vel"], ((n_cells, 0), (0, 0)), mode="edge")
        self._current_model["vxvz"] = np.pad(self._current_model["vxvz"], ((n_cells, 0), (0, 0)), mode="edge")
    ...
    def pad_bottom(self, n_cells):
        ...
        # Update velocity arrays with edge padding
        self._current_model["vel"] = np.pad(self._current_model["vel"], ((0, n_cells), (0, 0)), mode="edge")
        self._current_model["vxvz"] = np.pad(self._current_model["vxvz"], ((0, n_cells), (0, 0)), mode="edge")
