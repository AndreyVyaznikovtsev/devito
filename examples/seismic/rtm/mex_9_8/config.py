...
OUTPUT_BASE = "/home/andrey/devito-vti/examples/seismic/rtm" + "/mex_9_8"

PATH_MODEL = PATH_DATA_BASE + "/North_07_08_09.dat"
PATH_DATA_DPLUS = PATH_DATA_BASE + "/09-08_2.sgy"
PATH_DATA_DSUB = PATH_DATA_BASE + "/09-08_dsub_2.sgy"
...
def setup_model_and_geometry(iter, external=None):
    ...
    dataset_dplus = SeismogramDataset(PATH_DATA_DPLUS, "sou", invert_elevs=True, monkey_x=True)
    dataset_dsub = SeismogramDataset(PATH_DATA_DSUB, "sou", invert_elevs=True, monkey_x=True)
