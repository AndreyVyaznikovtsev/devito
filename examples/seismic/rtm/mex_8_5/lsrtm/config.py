...
# Paths
PATH_MODEL = "../../../data/North_04-05.dat" # Pr2
PATH_DATA_DPLUS = "/mnt/myshare/Андрей/!Аспирантура/08-05.sgy"
PATH_DATA_DSUB = "/mnt/myshare/Андрей/!Аспирантура/08-05_dsub.sgy"
...
# Output directories
OUTPUT_DIRS = {
    # 'forward_snaps': "/mnt/myshare/Андрей/!Аспирантура/mex_8_5/forward_snaps",
    # 'adjoint_snaps': "/mnt/myshare/Андрей/!Аспирантура/mex_8_5/adjoint_snaps",
    # 'gradients': "/mnt/myshare/Андрей/!Аспирантура/mex_8_5/gradients",
    'forward_snaps': "./forward_snaps",
    'adjoint_snaps': "./adjoint_snaps",
    'gradients': "./gradients",
    'images': "/mnt/myshare/Андрей/!Аспирантура/mex_8_5/images",
    'results': "/mnt/myshare/Андрей/!Аспирантура/mex_8_5/logs"
}
