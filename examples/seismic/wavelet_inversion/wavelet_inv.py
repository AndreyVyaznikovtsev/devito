...
def main():
    ...
    plt.savefig("Forward" + ".png", dpi=300, bbox_inches="tight", pad_inches=0.1)
    plt.close()
    ...
    for N in Ns:
        ...
        plt.savefig(
            f"wavelet_frames/Inverted Wavelet {N:.2f}" + ".png",
            dpi=300,
            bbox_inches="tight",
            pad_inches=0.1,
        )
        ...
        geometry = AcquisitionGeometry(model, rec_pos, src_pos, t0, tn, f0=f0 * 2, src_type=None, wav_data=wav3)
        ...
        plt.savefig(
            f"forward_frames/Forward + Inverted {N:.2f}" + ".png",
            dpi=300,
            bbox_inches="tight",
            pad_inches=0.1,
        )
