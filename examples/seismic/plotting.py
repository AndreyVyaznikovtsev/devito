...
def plot_seis_double_hor(seis1, seis2, time_range, z, titles, show=False):
    ...
    # Plot using imshow
    axs[0].imshow(seis1, aspect="auto", extent=extent, vmin=-vm1, vmax=vm1, cmap="gray")
    axs[1].imshow(seis2, aspect="auto", extent=extent, vmin=-vm2, vmax=vm2, cmap="gray")
